      ...
      <div className="container">
        ...
        <div className="row">
          <div className="col-lg-4 text-center">
            <img src={`${process.env.PUBLIC_URL}img/reference/ismail.jpeg`} alt="Ismail Bentabet" style={{ borderRadius: '50%', width: '170px' }} />
          ...
          <div className="col-lg-4 text-center">
            <img src={`${process.env.PUBLIC_URL}img/reference/khial.jpeg`} alt="Abderrahmane Khial" style={{ borderRadius: '50%', width: '170px' }} />
          ...
          <div className="col-lg-4 text-center">
            <img src={`${process.env.PUBLIC_URL}img/reference/sidnas.jpeg`} alt="Abderrahman Sidnas" style={{ borderRadius: '50%', width: '170px' }} />
